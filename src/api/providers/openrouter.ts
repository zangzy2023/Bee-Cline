...
export class OpenRouterHandler implements ApiHandler, SingleCompletionHandler {
	...
	constructor(options: ApiHandlerOptions) {
		...
		this.client = new OpenAI({
			...
			defaultHeaders: {
				"HTTP-Referer": "https://github.com/RooVetGit/Bee-Cline", // Optional, for including your app on openrouter.ai rankings.
				"X-Title": "Bee-Cline", // Optional. Shows in rankings on openrouter.ai.
			},
		})
	}
